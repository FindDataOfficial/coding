...
The key difference from code-creator: you write **tests first**, run them
...
4. Check if `src/` already has code from code-creator (you'll extend it with tests)
...
If `src/` already has code from code-creator, write tests that verify
